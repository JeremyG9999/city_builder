...
class CityBuilderGame:
    ...
    def game_play(self):
        if not self.paused:
            ...
            print("+" + "-"*16 + "+" + "-"*96 + "+", flush=True)
            print(f"| Population     | Citizens: {self.citizen_population:<6} | Soldiers: {self.soldier_population:<6} | Total Pop: {self.total_population:<6} | Pop Limit: {self.population_limit:<6} |" + " "*18 + "|", flush=True)
            print("+" + "-"*16 + "+" + "-"*96 + "+", flush=True)
